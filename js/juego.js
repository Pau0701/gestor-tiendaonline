...
// =============================================================================
  ...
  function renderizarTablero() {
    ...
    mazo.forEach(function(productos) {
      ...
      flipCard.dataset.idProductos = productos.id;
      ...
      flipCard.innerHTML =
        '<div class="flip-card-inner">' +
          '<div class="flip-card-front">' +
            ...
            '<span class="marca-reverso">MiTienda</span>' +
          '</div>' +
          '<div class="flip-card-back">' +
            '<img src="' + productos.imagen + '" alt="' + productos.nombre + '" loading="lazy" />' +
            '<div class="info-producto">' +
              '<p class="nombre-producto">' + productos.nombre + '</p>' +
              '<p class="precio-producto">$' + productos.precio.toLocaleString('es-CO') + '</p>' +
            '</div>' +
          '</div>' +
        '</div>';
